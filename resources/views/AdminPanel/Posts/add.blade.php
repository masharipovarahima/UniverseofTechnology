            ...
            <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-2/4">
                <div class="relative flex flex-col min-w-0 break-words bg-white shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                    <div class="flex-auto p-4">
                        ...
                        <div id="input_window" class="flex flex-row -mx-3 p-3" align="center">
                            <button onclick="document.getElementById('imgInp').click()" class="file-upload__wrapper w-full">
                        ...
                        <div id="img_window" onclick="document.getElementById('imgInp').click()" style="display: none;">
                            <img id="img_src" style="width: 99%" src="{{asset('assets/img/computer.jpg')}}">
                        </div>
            ...
            <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-2/4">
                <div class="relative flex flex-col min-w-0 break-words bg-white shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                    <form runat="server" action="{{route('Post.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="flex-auto p-4 w-full">
                            <div class="flex flex-row -mx-3 w-full p-3">
                                <input style="display: none" accept=".jpg" type='file' id="imgInp" required name="post">
                ...
                <div class="flex flex-wrap items-center -mx-3 lg:justify-between">
                    <div class="w-full max-w-full px-3 mt-0 mb-6 shrink-0 lg:mb-0 lg:w-1/2 lg:flex-none">
                        <div class="text-sm leading-normal text-center text-slate-500 lg:text-left">
                            ...
                            Created by
                            <a href="" class="font-semibold dark:text-white text-slate-700" target="_blank">M.Rahima</a>.
                        </div>
                    </div>
                </div>
            </div>
