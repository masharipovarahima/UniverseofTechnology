...
<header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                <li><a class="active " href="index">Asosiy</a></li>
    ...
    <div id="heroCarousel" class="container carousel carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-item active">
            <div class="carousel-container">
                <h2 class="animate__animated animate__fadeInDown">Texnologiyalar</h2>
                <p class="animate__animated animate__fadeInUp">Biz bilan birga eng yangi texnologiyalarda xabardor bo'ling</p>
            </div>
        </div>
        ...
        <div class="carousel-item">
            <div class="carousel-container">
                <h2 class="animate__animated animate__fadeInDown">Yo'nalishlar</h2>
                <p class="animate__animated animate__fadeInUp">Barcha yo'nalishlar to'g'risida to'liq ma'lumotlar</p>
            </div>
        </div>
